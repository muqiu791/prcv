...
def run_demo(model, irBase_path,irDetail_path, visBase_path, visDetail_path, output_path_root, index, BS,DS, mode):
    ...
    ############################ multi outputs ##############################################
    file_name = 'fuseME'+str(index) + '.png'
    output_path = output_path_root + file_name
...
def main():
    ...
    with torch.no_grad():
        ...
        for i in range(1): 
            index = i + 1
            irBase_path = test_path + 'IRBase0.png'
            irDetail_path = test_path + 'IRDetail0.png'
            visBase_path = test_path + 'VISBase0.png'
            visDetail_path = test_path + 'VISDetail0.png'

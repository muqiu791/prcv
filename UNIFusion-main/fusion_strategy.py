...
def AGL1Fusion(tensor1, tensor2, spatial_type='sum'):
    ...
    spatial1[0, 0, :, :] = torch.from_numpy(
        morphology.remove_small_holes(spatial1[0, 0, :, :].cpu().numpy(), area_threshold=h * w * 0.05, connectivity=2,
                                      in_place=False));
    if (args.cuda):
...
def spatial_fusion(tensor1, tensor2, spatial_type='sum'):
    ...
    spatial1 = spatial_attention(tensor1, spatial_type)
    spatial2 = spatial_attention(tensor2, spatial_type)
    # print("Spatial attention values:")
    # print("Spatial 1:", spatial1)
    # print("Spatial 2:", spatial2)
    ...
    #
    # print("tensor1 contains nan:", torch.isnan(tensor1).any())
    # print("tensor2 contains nan:", torch.isnan(tensor2).any())
    # print("tensor1 contains inf:", torch.isinf(tensor1).any())
    # print("tensor2 contains inf:", torch.isinf(tensor2).any())
    return tensor_f
